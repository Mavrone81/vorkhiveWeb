...
export const defaultContent = {
  ...
  footer: {
    ...
    columns: [
      { title: 'Platform', links: [{ label: 'Singapore payroll', href: '/payroll-singapore' }, { label: 'CPF payroll', href: '/cpf-payroll' }, { label: 'Leave management', href: '/leave-management' }, { label: 'Claims management', href: '/claims' }, { label: 'Pricing', href: '/pricing' }] },
